...
-- Module  Version: 3.4
--/home/soft/lattice/diamond/3.0_x64/ispfpga/bin/lin64/scuba -w -n random_size -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type lfsr -stage 32 -feedback_poly 58 -init_seed 01 -parallel_out -e 

-- Mon May  5 15:44:33 2014
...
begin
    ...
    LUT4_0: ROM16X1A
        ...
        port map (AD3=>lfsr_reg_out3, AD2=>lfsr_reg_out4, 
            AD1=>lfsr_reg_out6, AD0=>scuba_vlo, DO0=>lfsr_oddparity);
